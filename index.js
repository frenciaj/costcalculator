function ready() {
    ...
    var botonOption = "<div class='row' id='option6'><div class='col-xs-6' id='resultado'></div><div id='botoncalcular' class='col-xs-6'><button type='button' id='calculo' class='btn btn-warning'>Calcular</button></div></div><div class='row' id='result'></div> ";
    ...
    var celCosto;
    var startOver = "</h4><br><p>Muchas gracias por usar nuestra calculadora, si quiere calcular otro producto por favor haga click en el boton</p><div><button type='button' id='reload' class='btn btn-warning'>Volver a Empezar</button></div>";
                ...
                $(":radio").click(function() {
                    ...
                    $("#calculocm").click(function() {
                        ...
                        $("#valormetro").change(function() {
                            ...
                            $("#calculo").click(function() {
                                if (costoVal < costoM3) {
                                monto = "<h4>Su costo aproximado es U$S " + costoM3.toFixed(0);
                            console.log(costoM3);

                            }
                            else {
                                monto = "<h4>Su costo aproximado es U$S " + costoVal.toFixed(0);
                                                       console.log(costoVal);

                            }
                                $("#resultado").html(monto)
                                $("#result").html(startOver);
